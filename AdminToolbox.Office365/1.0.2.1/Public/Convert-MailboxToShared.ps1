function Convert-MailboxToShared {
    ...
    Requirements:
        ...
        2. This Function must be run from the server that hosts Azure AD Connect and the on-premise Account must be synce to an Exchange Online Mailbox.
...
5. Powershell version 5 is required
    ...
    process {
        ...
        do {
            ...
            #Switch that does the work for the menu's sleected options
            ...
            switch ($selection) {
                '1' {
                    ...
                    ##Perfom a mailbox copy from the disabled mailbox to the new mailbox
                    ...
                    ##onitor progress of the mailbox copy and remove completed requests
                    do {
