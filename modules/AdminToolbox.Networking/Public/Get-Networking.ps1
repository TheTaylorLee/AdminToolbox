function Get-Networking {
    ...
    Write-Host "Get-MacVendor              ..Gets Mac OUIs by Mac Addresses, IP Addresses, and Hostnames "           -ForegroundColor cyan
    Write-Host "Get-NetworkStatistics      ..Gets active connections and associated processes"                       -ForegroundColor cyan
    Write-Host "Get-NICConfig              ..Gets interface details from multiple commands and combines them"        -ForegroundColor cyan
    Write-Host "Get-PublicIP               ..Gets Public IP info and Geolocation"                                    -ForegroundColor cyan
    Write-Host "Get-SpeedTestCLI           ..Downloads the Ookla Speedtest CLI (Subject to their usage policy)"      -ForegroundColor cyan
