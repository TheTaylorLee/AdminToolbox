#
# Module manifest for module 'AdminToolbox.SecOps'
#
...
ModuleVersion = '1.5.0.21'

# Supported PSEditions
CompatiblePSEditions = 'Desktop', 'Core'

# ID used to uniquely identify this module
GUID = 'eca492e0-fcea-49b8-8dfd-f6c4ea520be6'
...
FunctionsToExport = 'Get-SecOps', 'Convert-Base64', 'Get-BitlockerRecovery', 
               'Get-HiddenServices', 'Invoke-BitlockerSetup', 'Set-UAC', 
               'Set-ScreenTimeout', 'Set-DNSBroadcasting', 
               'Disable-WindowsTelemetry', 'Dismount-ProfileRegistry', 
