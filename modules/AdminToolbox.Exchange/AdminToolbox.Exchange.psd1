#
# Module manifest for module 'AdminToolbox.Exchange'
#
...
ModuleVersion = '1.10.0.55'

# Supported PSEditions
CompatiblePSEditions = 'Desktop', 'Core'

# ID used to uniquely identify this module
GUID = 'dca88aa3-ba84-4043-8aa9-b05e42bfaa46'
...
FunctionsToExport = 'Get-Exchange', 'Add-DistributionMember', 'Get-MailLog', 
               'Get-UserDisabledMailboxes', 'Get-VirtualDirectories', 
               'Set-VirtualDirectories', 'Get-MailboxScaleReport', 
               'Get-MailboxAccessOWAOnly', 'Enable-365MailboxExistingUser', 
               'Connect-ExchangeServer', 'Disconnect-ExchangeServer', 
               'get-mailboxreport'
