...
* **1.7.0.105** CI Maintenance Release
* **1.8.0.0** Add Get-FormattedDate
* **1.8.0.1** CI Maintenance Release
* **1.8.0.2** CI Maintenance Release
* **1.8.0.3** CI Maintenance Release
* **1.8.0.4** CI Maintenance Release
* **1.8.0.5** CI Maintenance Release
* **1.8.0.6** CI Maintenance Release
* **1.8.0.7** CI Maintenance Release
* **1.8.0.8** CI Maintenance Release
* **1.8.0.9** CI Maintenance Release
* **1.8.0.10** CI Maintenance Release
* **1.8.0.11** CI Maintenance Release
* **1.8.0.12** CI Maintenance Release
* **1.8.0.13** CI Maintenance Release
* **1.8.0.14** CI Maintenance Release
* **1.8.0.15** CI Maintenance Release
* **1.8.0.16** CI Maintenance Release
* **1.8.0.17** CI Maintenance Release
* **1.8.0.18** CI Maintenance Release
* **1.8.0.19** CI Maintenance Release
* **1.8.0.20** CI Maintenance Release
* **1.8.0.21** CI Maintenance Release
* **1.8.0.22** CI Maintenance Release
* **1.8.0.23** CI Maintenance Release
* **1.8.0.24** CI Maintenance Release
* **1.8.0.25** CI Maintenance Release
* **1.8.0.26** CI Maintenance Release
* **1.8.0.27** CI Maintenance Release
* **1.8.0.28** CI Maintenance Release