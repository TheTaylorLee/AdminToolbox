...
ModuleVersion = '2.11.12'

# Supported PSEditions
CompatiblePSEditions = 'Desktop', 'Core'

# ID used to uniquely identify this module
GUID = 'f2b99285-af9c-4db0-bcff-2ac8da45819f'
...
FunctionsToExport = 'Get-Office365', 'Get-MFAStatus', 'Get-AzureRoleMembers', 
               'Get-MsolRoleMembers', 'Connect-Office365', 'Convert-MailboxToShared', 
               'Get-AuthPolicy', 'New-AuthPolicy', 'Set-AuthPolicy', 'Invoke-Sync365', 
               'Get-GuestUsers', 'Set-PasswordNeverExpire', 'Set-365GroupVisibility', 
               'Unblock-Quarantine', 'Get-Quarantine', 'Set-Subscription', 
               'Invoke-PowerState', 'Get-VMDetails', 'Get-TenantDiagrams', 
               'Invoke-EXOSharedSession', 'Enable-MailboxAccess', 'Clear-TeamsCache', 
               'Invoke-PerUserMFAEnforced', 'Get-DistributionGroupMembers'
