...
ModuleVersion = '5.4.0.14'

# Supported PSEditions
CompatiblePSEditions = 'Desktop', 'Core'

# ID used to uniquely identify this module
GUID = '189e61ad-0b89-49a5-86c0-4bb3dcc165c6'
...
FunctionsToExport = 'Get-Office365', 'Convert-MailboxToShared', 'Invoke-Sync365', 
               'Set-365GroupVisibility', 'Unblock-Quarantine', 'Get-Quarantine', 
               'Set-Subscription', 'Invoke-PowerState', 'Get-VMDetails', 
               'Invoke-EXOSharedSession', 'Enable-MailboxAccess', 
               'Get-DistributionGroupMembers', 'Remove-VersionHistoryOlderThan', 
               'Get-VersionHistoryReport', 'Set-SharepointVersionLimits', 
               'Set-SiteOwner', 'Get-MailboxDelegatesReport', 
               'Add-AzRoutesToRouteTable', 'Add-SiteCollectionAdmin', 
