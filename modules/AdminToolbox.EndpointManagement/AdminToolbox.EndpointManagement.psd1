...
ModuleVersion = '4.15.1.29'

# Supported PSEditions
CompatiblePSEditions = 'Desktop', 'Core'

# ID used to uniquely identify this module
GUID = '99ed6ca4-e133-4077-937f-1b13e107c38c'
...
FunctionsToExport = 'Add-LocalAdmin', 'Disable-Firewall', 'Disable-PasswordPeek', 
               ...
               'Remove-Shortcuts', 'Remove-Tiles', 'Get-ChocoInstalls', 
               'Uninstall-Application', 'Reset-EndpointPassword', 
               'Repair-DomainJoin', 'Disable-Cortana', 'Get-MonitorSizes', 
               'Get-RebootEvents', 'Get-RemoteDesktopLogins', 
               'Get-LocalLogonHistory', 'Get-WindowsProfiles'
