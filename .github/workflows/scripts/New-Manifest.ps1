...
Function New-Manifest {
    ...
    if ($Office365) {
        ...
        $Params = @{
            CompatiblePSEditions = "Desktop", "Core"
            FunctionsToExport    = 'Get-Office365', 'Connect-Office365', 'Convert-MailboxToShared', 'Invoke-Sync365', 'Set-365GroupVisibility', 'Unblock-Quarantine', 'Get-Quarantine', 'Set-Subscription', 'Invoke-PowerState', 'Get-VMDetails', 'Get-TenantDiagrams', 'Invoke-EXOSharedSession', 'Enable-MailboxAccess', 'Clear-TeamsCache', 'Get-DistributionGroupMembers'
