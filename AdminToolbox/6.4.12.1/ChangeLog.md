...
* **6.4.11.0** Added regex validation for cidr on function parameters for invoke-networkscan in module admintoolbox.networking
* **6.4.12.0** Filtering null results for invoke-networkscan in module admintoolbox.networking
* **6.4.12.1** Updated help for nvoke-networkscan in module admintoolbox.networking