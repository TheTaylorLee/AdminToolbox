...
GUID = '9945ac71-9ccc-4c87-b55d-a084b552f7b4'
...
PrivateData = @{
    ...
    PSData = @{
        ...
        Tags = '365', 'Active', 'ActiveDirectory', 'Automate', 'Application', 'Directory', 
               'Exchange', 'FileManagement', 'Fortinet', 'FortiGate', 'FortiOS', 'Iperf', 
               'Network', 'Networking', 'NetworkScan', 'Office', 'Office365', 'OpenSSH', 
               'PC', 'PCSetup', 'Print', 'Printer', 'Remoting', 'Robocopy', 'Setup', 'SSH', 
               'vmware', 'Windows'
