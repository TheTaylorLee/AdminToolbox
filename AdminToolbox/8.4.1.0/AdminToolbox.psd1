...
RequiredModules = @(@{ModuleName = 'AdminToolbox.ActiveDirectory'; ModuleVersion = '1.3.1.0'; }, 
               @{ModuleName = 'AdminToolbox.EndpointManagement'; ModuleVersion = '4.3.0.0'; }, 
               @{ModuleName = 'AdminToolbox.Exchange'; ModuleVersion = '1.5.0.0'; }, 
               @{ModuleName = 'AdminToolbox.FFTools'; ModuleVersion = '4.4.0.0'; }, 
               @{ModuleName = 'AdminToolbox.FileManagement'; ModuleVersion = '1.4.0.0'; }, 
               @{ModuleName = 'AdminToolbox.Fun'; ModuleVersion = '1.2.0.1'; }, 
               @{ModuleName = 'AdminToolbox.Networking'; ModuleVersion = '2.5.2.0'; }, 
               @{ModuleName = 'AdminToolbox.Office365'; ModuleVersion = '2.2.2.0'; }, 
               @{ModuleName = 'AdminToolbox.Remoting'; ModuleVersion = '1.2.0.1'; }, 
               @{ModuleName = 'AdminToolbox.VMWareAutomate'; ModuleVersion = '4.3.1.0'; }, 
