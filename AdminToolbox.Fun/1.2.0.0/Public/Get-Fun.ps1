function Get-Fun {
    ...
    Write-Host "Fun Functions"                                                                             -Foregroundcolor green
    Write-Host "Get-CloseEncounters        ..Get Close Encounters"                                         -Foregroundcolor cyan
    Write-Host "Get-Creed                  ..Gets the powershell creed"                                    -Foregroundcolor cyan
    Write-Host "Get-Emote                  ..Gets a Kaomoji"                                               -Foregroundcolor cyan
    ...
    Write-Host "Invoke-EjectTray           ..Invokes cd tray being ejected"                                -Foregroundcolor cyan
    Write-Host "Invoke-Speak               ..Invokes the windows speech synthesizer"                       -Foregroundcolor cyan
    Write-Host "Start-Snake                ..Play a game of Snake"                                         -Foregroundcolor cyan
    Write-Host " "
}