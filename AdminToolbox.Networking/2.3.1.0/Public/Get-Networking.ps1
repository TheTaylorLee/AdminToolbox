function Get-Networking {
    ...
    Write-Host "Invoke-NetworkScan         ..Invoke a netwrok scan for Hostnames, IPv4, MAC, OUI, and Ports" -ForegroundColor cyan
    ...
    Write-Host "Remove-NetNeighbour        ..Removes the local arp Cache"                                    -Foregroundcolor cyan
